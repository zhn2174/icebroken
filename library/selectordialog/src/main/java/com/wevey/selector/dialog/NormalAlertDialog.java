...
public class NormalAlertDialog implements View.OnClickListener {
    ...
    public NormalAlertDialog(Builder builder) {
        ...
        mLineColor = (View) mDialogView.findViewById(R.id.dialog_normal_lineColor);
        mLinearLayoutBackground = (LinearLayout) mDialogView.findViewById(R.id.dialog_normal_titleBackground);
    ...
    private void initDialog(Builder builder) {
        ...
        mLineColor.setBackgroundResource(builder.getLineColor());
        ...
        mLinearLayoutBackground.setBackgroundResource(builder.getLlBackground());
    ...
    public static class Builder {
        ...
        public Builder setLlBackground(int llBackground) {
