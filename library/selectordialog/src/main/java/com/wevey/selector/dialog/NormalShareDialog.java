...
public class NormalShareDialog {
    ...
    public NormalShareDialog(Builder builder) {

        this.mBuilder = builder;
        mDialog = new Dialog(mContext, R.style.bottomDialogStyle);
        dialogView = View.inflate(mContext, R.layout.share_bottom_dialog, null);
        mDialog.setContentView(dialogView); // 一定要在setAttributes(lp)之前才有效

        //设置dialog的宽
        Window dialogWindow = mDialog.getWindow();
        WindowManager.LayoutParams lp = dialogWindow.getAttributes();
        lp.width = (int) (ScreenSizeUtils.getInstance(mContext).getScreenWidth() * 0.95);
...
//            }
    ...
    public static class Builder {
        ...
        public NormalShareDialog build() {

            return new NormalShareDialog(this);
        }
    }
