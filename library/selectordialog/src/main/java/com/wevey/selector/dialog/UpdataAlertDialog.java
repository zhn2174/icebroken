 ...
 */
public class UpdataAlertDialog implements View.OnClickListener {
    ...
    public UpdataAlertDialog(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdataAlertDialog build() {
            return new UpdataAlertDialog(this);
        }
    }
