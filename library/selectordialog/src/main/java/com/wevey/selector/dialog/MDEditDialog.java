...
public class MDEditDialog implements View.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public MDEditDialog(Builder builder) {
        ...
        mTime = (TextView) mDialogView.findViewById(R.id.time);
        mAddress = (TextView) mDialogView.findViewById(R.id.address);
...
//        mTitle.setText(mBuilder.getTitleText());
        ...
        mTime.setText(mBuilder.getTitleText());
        mAddress.setText(mBuilder.getContentText());
