...
//    private int mIndicatorSelectedResId = R.drawable.index_cicle_selct;
//    private int mIndicatorUnselectedResId = R.drawable.index_cicle;
    private GradientDrawable Selectebg = new GradientDrawable();
    private GradientDrawable Unselectebg = new GradientDrawable();
...
//    private List<TextView> indicatorImages;
    ...
    public void setSelectBackcolor(int selectBackcolor) {
        ...
        Selectebg= new GradientDrawable();// 创建drawable
        Selectebg.setColor(selectBackcolor);
        Selectebg.setCornerRadius(fromDPToPix(5));
    }

    public int getUnselectBackcolor() {
        return unselectBackcolor;
    }

    public void setUnselectBackcolor(int unselectBackcolor) {
        this.unselectBackcolor = unselectBackcolor;
        Unselectebg= new GradientDrawable();// 创建drawable
        Unselectebg.setColor(unselectBackcolor);
        Unselectebg.setCornerRadius(fromDPToPix(5));
    }
    ...
    private  int fromDPToPix(int dp) {
...
//        Selectebg= new GradientDrawable();// 创建drawable
//        Selectebg.setColor(Color.parseColor(unselectBackcolor));
//        Selectebg.setCornerRadius(fromDPToPix(5));
//        Unselectebg= new GradientDrawable();// 创建drawable
//        Unselectebg.setColor(selectBackcolor);
//        Unselectebg.setCornerRadius(fromDPToPix(5));
...
//            // 代码中得到dp值
            ...
            int pageMargin2 = (int) TypedValue.applyDimension(
                    TypedValue.COMPLEX_UNIT_DIP, 4, getResources().getDisplayMetrics());
            int pageMargin3 = (int) TypedValue.applyDimension(
                    TypedValue.COMPLEX_UNIT_DIP, 4, getResources().getDisplayMetrics());
            if (i == 0) {
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(pageMargin2, pageMargin2);
                imageView.setLayoutParams(lp);
                lp.leftMargin = pageMargin3;
//                imageView.setImageResource(mIndicatorSelectedResId);
//                imageView.setBackgroundColor(selectBackcolor);
                imageView.setBackground(Selectebg);
            } else {
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(pageMargin, pageMargin);
                imageView.setLayoutParams(lp);
                lp.leftMargin = pageMargin3;
//                imageView.setImageResource(mIndicatorUnselectedResId);
//                imageView.setBackgroundColor(Color.parseColor("#00000000"));
                imageView.setBackground(Unselectebg);
            }
            ...
            if (bannerStyle == BannerConfig.CIRCLE_INDICATOR ||
                ...
                indicatorInside.addView(imageView);
        }
    }
...
//        Log.i(tag, ev.getAction() + "--" + isAutoPlay);
    ...
    public void onPageSelected(int position) {
        ...
        if (bannerStyle == BannerConfig.CIRCLE_INDICATOR ||
            ...
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(pageMargin2, pageMargin2);
            lp.leftMargin = pageMargin3;
            LinearLayout.LayoutParams lp1 = new LinearLayout.LayoutParams(pageMargin, pageMargin);
            lp1.leftMargin = pageMargin3;
            indicatorImages.get((lastPosition - 1 + count) % count).setLayoutParams(lp1);
            indicatorImages.get((position - 1 + count) % count).setLayoutParams(lp);
//            indicatorImages.get((lastPosition - 1 + count) % count).setImageResource(mIndicatorUnselectedResId);
//            indicatorImages.get((lastPosition - 1 + count) % count).setBackgroundColor(Color.parseColor("#00000000"));
            indicatorImages.get((lastPosition - 1 + count) % count).setBackground(Unselectebg);
//            indicatorImages.get((position - 1 + count) % count).setImageResource(mIndicatorSelectedResId);
//            indicatorImages.get((position - 1 + count) % count).setBackgroundColor(selectBackcolor);
            indicatorImages.get((position - 1 + count) % count).setBackground(Selectebg);
