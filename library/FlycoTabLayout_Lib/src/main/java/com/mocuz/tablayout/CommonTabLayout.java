...
import com.mocuz.tablayout.utils.FragmentChangeManager;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private int mHeight;
//    private String nomalcolor ="#ffffff";
//    private int selectcolor ;
    ...
    public void hideview(int position){
        mTabsContainer.getChildAt(position).setVisibility(GONE);
    }
...
//                if (i == mCurrentTab){
//                    iv_tab_icon.setBackgroundColor(selectcolor);
//                }else{
//                    iv_tab_icon.setBackgroundColor(Color.parseColor(nomalcolor));
//                }
