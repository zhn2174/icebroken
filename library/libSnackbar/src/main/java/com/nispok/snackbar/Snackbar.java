...
public class Snackbar extends SnackbarLayout {
    ...
    private ImageView sb__icon;
    private LinearLayout sb__inner;
    private int colorId;
    ...
    public Snackbar icon_bg(int resId) {
        colorId = resId;
        return this;
    }
...
//            layout.setBackgroundColor(mColor);
        ...
        sb__inner = (LinearLayout) layout.findViewById(R.id.sb__inner);
        sb__inner.setOnClickListener(new OnClickListener() {
            @Override
        ...
        gd.setColor(colorId);
        sb__icon = (ImageView) layout.findViewById(R.id.sb__icon);
        sb__icon.setBackgroundDrawable(gd);
