 ...
 */
public class BigImagePagerActivity extends BaseCommonActivity {
                ...
                if (imgurl.contains("http")) {
                    imageView.setOnLongClickListener(new View.OnLongClickListener() {
                        ...
                        public boolean onLongClick(View v) {
                            AlertDialog dialog = new AlertDialog.Builder(BigImagePagerActivity.this)
                                    .setTitle("提示")
                                    .setMessage("是否要下载图片？")
                                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            SDFileHelper helper = new SDFileHelper(BigImagePagerActivity.this);
                                            helper.savePicture("IMG" + System.currentTimeMillis() + ".jpeg", imgurl);
                            ...
                            dialog.show();
                            String baseShared = mContext.getPackageName().replace("com.mocuz.", "").replace(".", "");
                            int color = Color.parseColor(mContext.getSharedPreferences(baseShared,
                                    Context.MODE_PRIVATE).getString(mContext.getPackageName().replace("com.mocuz.", "").replace(".", "") + "_endcolor", "#78BD50"));
