...
public class FloatingDragger implements Observer {
    ...
    public FloatingDragger(Activity context, @LayoutRes int layoutResID) {
        ...
        floatingDraggedView.addView(floatingView, new FrameLayout.LayoutParams(dip2px(context, 60), dip2px(context, 60)));
