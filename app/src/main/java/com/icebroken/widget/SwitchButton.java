...
public class SwitchButton extends View {
     ...
     * 获取动画是否开启
     *
     * @return (boolean) isEnableAnimation
     *
     * @see true 开启(默认) false 关闭
     */
     ...
     * @see true 开启(默认) false 关闭
     */
    public void setEnableAnimation(boolean isEnableAnimation) {
        this.isEnableAnimation = isEnableAnimation;
    }
     ...
     * @param wich
     */
    private void togglemSwitch(int wich) {
    ...
    public interface OnStateChangedListener {
        void toggleToOn(View mView);

        void toggleToOff(View mView);
    }

    private OnStateChangedListener listener = new OnStateChangedListener() {

        @Override
        public void toggleToOn(View mView) {
            // toggleSwitch(STATE_SWITCH_ON);
        }

        @Override
        public void toggleToOff(View mView) {
            // toggleSwitch(STATE_SWITCH_OFF);
        }
    };
     ...
     * @param listener
     *
     * @throws IllegalArgumentException (OnStateChangedListener is empty please check)
     */
