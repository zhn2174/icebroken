...
public class ReplyEmojiLayout extends AutoHeightLayout implements View.OnClickListener, EmoticonsFuncView.OnEmoticonsPageViewListener,
    ...
    protected EmoticonsEditText nEtChat;
    ...
    public ReplyEmojiLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void inflateKeyboardBar() {
        mInflater.inflate(R.layout.layout_reply_emojy, this);
    }
...
//        mEtChat.requestFocus();
        ...
        EmoticonsKeyboardUtils.openSoftKeyboard(nEtChat);
    }
...
//        showText();
        mLyKvml.toggleFuncView(key, isSoftKeyboardPop(), nEtChat);
    }
            ...
            default:
                if (event.getAction() == KeyEvent.ACTION_DOWN) {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                        isFocused = nEtChat.getShowSoftInputOnFocus();
                    } else {
                        isFocused = nEtChat.isFocused();
                    }
                    if (isFocused) {
                        nEtChat.onKeyDown(event.getKeyCode(), event);
                    }
                }
                return false;
        }
    ...
    public EmoticonsEditText getnEtChat() {
        return nEtChat;
    }

    public void setnEtChat(EmoticonsEditText nEtChat) {
