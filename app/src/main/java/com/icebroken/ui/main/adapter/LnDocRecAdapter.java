...
public class LnDocRecAdapter extends BaseQuickAdapter<LnSignInBean,BaseViewHolder>{


    public LnDocRecAdapter(List<LnSignInBean> data) {
    ...
    protected void convert(BaseViewHolder helper,  LnSignInBean item) {
        ...
        helper.setText(R.id.textType, "收文类型："+item.getRec_type());
