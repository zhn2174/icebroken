 ...
 * 未签收
 */
public class LnSignInNotFragment  extends BaseFragment implements SwipyRefreshLayout.OnRefreshListener, DatePickerDialog.OnDateSetListener{
    ...
    protected int getLayoutResource() {
        return R.layout.ln_fragment_signin_not;
    }
    ...
    protected void initView() {
        ...
        start_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                isStart=true;
                DatePickerDialog.newInstance(LnSignInNotFragment.this, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show(getActivity().getFragmentManager(), "datePicker");
            }
        });
